...
ALLOWED_USES = ("summarize-and-link", "short-quote-and-cite", "metadata-only", "image-public-domain", "text-public-domain")
...
CURATED = [
    ...
    {"id": "europeana", "name": "Europeana", "category": "public-domain",
     "url": "https://www.europeana.eu/", "feed": None,
     "api": "https://pro.europeana.eu/page/apis",
     "purpose": "European aggregator of cultural heritage from thousands of institutions across the EU; tens of millions of items, with a large public-domain and openly-licensed subset.",
     "signal_provided": "the European cultural commons",
     "allowed_use": "image-public-domain", "risk_level": "green", "license": "rights statements per item; use public domain / CC0 / CC items",
     "ingestion_method": "api", "rate_limit": "free API key required", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Filter by rights statement. Free API key required. The widest European net."},
    {"id": "harvard-art-museums", "name": "Harvard Art Museums", "category": "museum",
     "url": "https://www.harvardartmuseums.org/", "feed": None,
     "api": "https://api.harvardartmuseums.org/",
     "purpose": "Open API for 250,000+ works from Harvard's collections; public-domain images for items so marked.",
     "signal_provided": "the visual and historical record, with strong scholarship",
     "allowed_use": "image-public-domain", "risk_level": "green", "license": "public-domain items free to use; check per item",
     "ingestion_method": "api", "rate_limit": "free API key required", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Free API key required. Filter to public-domain or no-known-copyright items."},
    {"id": "paris-musees", "name": "Paris Musées Open Content", "category": "museum",
     "url": "https://www.parismusees.paris.fr/en", "feed": None,
     "api": "https://parismuseescollections.paris.fr/en",
     "purpose": "Over 150,000 CC0 works from Paris's municipal museums released as Open Content.",
     "signal_provided": "the Paris municipal collections",
     "allowed_use": "image-public-domain", "risk_level": "green", "license": "CC0 for Open Content items",
     "ingestion_method": "api", "rate_limit": "documented", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Covers the Petit Palais, Musée Carnavalet, and other Paris municipal museums. Use CC0 items."},
    {"id": "smk-denmark", "name": "Statens Museum for Kunst (SMK)", "category": "museum",
     "url": "https://www.smk.dk/en/", "feed": None,
     "api": "https://www.smk.dk/en/article/smk-api/",
     "purpose": "Denmark's national gallery; open API and CC0 public-domain works.",
     "signal_provided": "the Nordic visual record",
     "allowed_use": "image-public-domain", "risk_level": "green", "license": "CC0 for public-domain works",
     "ingestion_method": "api", "rate_limit": "documented", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Open API; filter to public-domain works."},
    {"id": "wellcome-collection", "name": "Wellcome Collection", "category": "public-domain",
     "url": "https://wellcomecollection.org/", "feed": None,
     "api": "https://developers.wellcomecollection.org/",
     "purpose": "Public-domain and openly-licensed images and texts on health, medicine, the body, and the human condition.",
     "signal_provided": "the historical record of medicine, body, and mind",
     "allowed_use": "image-public-domain", "risk_level": "green", "license": "CC0 and CC BY for openly-licensed items",
     "ingestion_method": "api", "rate_limit": "documented", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Use items marked Public Domain or CC0; CC BY items require attribution."},
    {"id": "yale-lux", "name": "Yale LUX (Collections Discovery)", "category": "museum",
     "url": "https://lux.collections.yale.edu/", "feed": None,
     "api": "https://lux.collections.yale.edu/api/",
     "purpose": "Cross-collection discovery across Yale's museums, library, and archives; public-domain items free to use.",
     "signal_provided": "the Yale collections, linked",
     "allowed_use": "image-public-domain", "risk_level": "green", "license": "rights vary; use public-domain items",
     "ingestion_method": "api", "rate_limit": "documented", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Includes Yale Center for British Art and Yale University Art Gallery, both with public-domain image programs."},
    {"id": "project-gutenberg", "name": "Project Gutenberg", "category": "public-domain",
     "url": "https://www.gutenberg.org/", "feed": None,
     "api": "https://www.gutenberg.org/cache/epub/feeds/",
     "purpose": "Over 70,000 public-domain books and texts, the canonical source for out-of-copyright literature. The primary source for The Reading.",
     "signal_provided": "the literary commons",
     "allowed_use": "text-public-domain", "risk_level": "green", "license": "public domain in the U.S.; per-country status varies",
     "ingestion_method": "manual-curated", "rate_limit": "mirrors and feeds available", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Use texts marked public domain. Strip the Project Gutenberg license header to present the bare PD text, or honor the small attribution if kept."},
    {"id": "standard-ebooks", "name": "Standard Ebooks", "category": "public-domain",
     "url": "https://standardebooks.org/", "feed": "https://standardebooks.org/feeds/atom",
     "api": None,
     "purpose": "Carefully produced, public-domain ebooks with modern typography. A curator's source for The Reading.",
     "signal_provided": "polished public-domain literature",
     "allowed_use": "text-public-domain", "risk_level": "green", "license": "CC0 for Standard Ebooks' typesetting; underlying texts public domain",
     "ingestion_method": "feed", "rate_limit": "atom feed", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Same texts as Project Gutenberg, better produced. Free, CC0 typesetting."},
    {"id": "wikisource", "name": "Wikisource", "category": "public-domain",
     "url": "https://en.wikisource.org/", "feed": None,
     "api": "https://en.wikisource.org/w/api.php",
     "purpose": "Multilingual library of public-domain and openly-licensed texts, with strong global coverage including Martí, Lorca, and other voices Project Gutenberg may not carry.",
     "signal_provided": "the multilingual literary commons",
     "allowed_use": "text-public-domain", "risk_level": "green", "license": "public domain or CC BY-SA per item",
     "ingestion_method": "api", "rate_limit": "MediaWiki API, honor maxlag", "robots_ok": True,
     "terms_checked": False, "last_checked": None,
     "notes": "Use items marked public domain. CC BY-SA items require credit and share-alike."},
]
